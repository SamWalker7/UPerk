    ...
    <div className="min-h-screen bg-white dark:bg-[#060a14] text-gray-900 dark:text-white">
      ...
      <section className="px-4 sm:px-6 pt-28 pb-16 sm:pt-32 sm:pb-20">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-[13px] font-semibold tracking-wide uppercase text-blue-600 dark:text-blue-400 mb-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <button
              ...
              className="w-full sm:w-auto rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-[15px] font-semibold px-6 py-3 transition"
      ...
      <section className="border-y border-gray-100 dark:border-gray-800/60 py-8 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
          {[
            ...
            <div key={item} className="text-[13px] sm:text-sm font-medium text-gray-500 dark:text-gray-400">
              {item}
            </div>
          ))}
        </div>
      ...
      <section className="px-4 sm:px-6 py-16 sm:py-20">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold tracking-tight mb-5 text-center">
            The problem isn't that answering services don't exist.
          </h2>
          <p className="text-base text-gray-600 dark:text-gray-400 leading-relaxed text-center max-w-2xl mx-auto">
            It's that most of them can't touch patient or client data safely.
            The moment an AI agent hears a name, a condition, or a case
            detail, a $99-a-month tool without a BAA becomes a compliance
            problem — which is usually why your last look at "AI for the
            front desk" ended with legal saying no. This is the version of
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={step.n}>
                <div className="text-[13px] font-bold text-blue-600 dark:text-blue-400 mb-2">
                  {step.n}
                </div>
      ...
      <section className="px-4 sm:px-6 py-16 sm:py-20">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link
            href="/creva"
            className="inline-flex items-center gap-1.5 text-[15px] font-semibold text-blue-600 dark:text-blue-400 hover:underline"
          >
          ...
          <div className="space-y-8">
            {OBSTACLES.map((item) => (
              <div key={item.q} className="border-b border-gray-200 dark:border-gray-800/60 pb-8 last:border-0 last:pb-0">
                <h3 className="text-[16px] font-semibold mb-2">{item.q}</h3>
      ...
      <section className="px-4 sm:px-6 py-16 sm:py-20">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <button
            ...
            className="rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-[15px] font-semibold px-8 py-3.5 transition"
            data-analytics-event="quote_form_open_click"
          >
            Talk to us about your call volume
          </button>
