    ...
    <div className="relative w-full max-w-lg">
      ...
      <div className="relative rounded-2xl border border-white/10 bg-[#0d1117]/80 backdrop-blur-sm overflow-hidden shadow-2xl">
        ...
        <div className="px-5 py-3 border-b border-white/10 flex items-center gap-2">
          ...
          <span className="ml-3 text-[13.5px] text-gray-400 font-mono">creva.ai · Interview Engine</span>
        </div>
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="flex items-center gap-3 p-4 rounded-xl bg-white/5 border border-white/10">
            <div
              className="w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-[15.5px] flex-shrink-0"
              style={{ background: "linear-gradient(135deg, #7c3aed, #2563EB)" }}
            >
              JD
            </div>
            <div className="flex-1 min-w-0">
              <div className="text-[15.5px] font-semibold text-white">Jane Doe</div>
              <div className="text-[13.5px] text-gray-400">Senior Engineer · Applied 2h ago</div>
            </div>
            <div className="text-right flex-shrink-0">
              <div
                className="text-[24px] font-extrabold bg-clip-text text-transparent"
                style={{ backgroundImage: "linear-gradient(to right, #7c3aed, #34E5FF)" }}
              >
                94%
              </div>
              <div className="text-[12.5px] text-gray-400">Match Score</div>
            </div>
          </div>
          ...
          <div className="p-4 rounded-xl bg-white/5 border border-white/10">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-[13.5px] text-gray-300 font-medium">
          ...
          <div className="flex flex-wrap gap-2">
            {["OpenAI GPT-4o", "ElevenLabs Voice", "Deepgram STT", "LangChain"].map((tool) => (
              <span
                key={tool}
                className="text-[12.5px] font-medium px-2.5 py-1 rounded-full bg-violet-500/15 border border-violet-500/25 text-violet-300"
              >
                {tool}
              </span>
            ))}
          ...
          <div className="grid grid-cols-3 gap-2">
            {[
              ...
              >
                ...
                <div className="text-[12.5px] text-gray-400">{item.label}</div>
              </div>
            ))}
          </div>
        </div>
...
export default function CrevaClient() {
  return (
    <div className="min-h-screen bg-white dark:bg-[#060a14] text-gray-900 dark:text-white">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1 max-w-2xl">
              <div className="flex items-center gap-3 mb-6">
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-violet-100 dark:bg-violet-500/15 border border-violet-200 dark:border-violet-500/25 text-violet-700 dark:text-violet-300 text-[13.5px] font-semibold">
                  AI Platform · SaaS
                </span>
                <span className="text-gray-500 dark:text-gray-500 text-[13.5px]">Recruitment · HR Technology</span>
              </div>
              ...
              <div className="grid grid-cols-3 divide-x divide-gray-200 dark:divide-white/10 border border-gray-200 dark:border-white/10 rounded-2xl bg-white dark:bg-white/[0.04] backdrop-blur-sm max-w-md shadow-sm shadow-violet-100/80 dark:shadow-none">
                {[
                  ...
                  <div key={stat.label} className="py-4 px-4 text-center">
                    ...
                    <div className="text-[12.5px] text-gray-600 dark:text-gray-400 mt-0.5 font-medium">{stat.label}</div>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              >
                <div
                  className="w-10 h-10 rounded-full flex items-center justify-center text-white text-[14.5px] font-bold mb-4"
                  style={{ background: "linear-gradient(135deg, #7c3aed, #2563EB)" }}
                >
                  {item.step}
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {PAIN_POINTS.map((point, i) => (
              ...
              >
                <h3 className="text-[20px] font-bold text-white mb-3">{point.title}</h3>
                <p className="text-violet-100 text-[16px] leading-relaxed">{point.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50/60 dark:bg-gray-900/20">
        <div className="max-w-7xl mx-auto">
            ...
            {AI_STACK.map((tool) => (
              ...
              >
                <div className="flex items-center gap-2.5 mb-2">
                  ...
                  />
                  <span className={`text-[15.5px] font-bold ${tool.text}`}>{tool.name}</span>
                </div>
          ...
          <div>
            <p className="text-center text-[13.5px] font-semibold uppercase tracking-widest text-gray-400 dark:text-gray-500 mb-6">
            ...
            {ACCOMPLISHMENTS.map((item) => (
              ...
              >
                <div className="flex items-center gap-2.5 mb-3">
                  ...
                  <h3 className="text-[18px] font-bold text-gray-900 dark:text-white">{item.title}</h3>
                </div>
                <p className="text-[15px] text-gray-500 dark:text-gray-400 leading-relaxed">
                  {item.description}
                </p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50/60 dark:bg-gray-900/20">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/#case-studies"
              className="px-8 py-4 font-semibold rounded-full text-[16.5px] border border-gray-200 dark:border-gray-700/60 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-white/[0.04] transition-all inline-block"
            >
