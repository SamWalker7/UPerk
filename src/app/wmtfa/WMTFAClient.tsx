...
export default function WMTFAClient() {
  return (
    <div className="min-h-screen bg-white dark:bg-[#060a14] text-gray-900 dark:text-white">
      ...
      <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div className="absolute inset-0 -z-10 bg-gradient-to-br from-blue-50 via-white to-cyan-50 dark:hidden" />
        <div
          className="absolute inset-0 -z-10 hidden dark:block"
          style={{ background: "linear-gradient(135deg, #060a14 0%, #0c1a3a 50%, #060a14 100%)" }}
        />
        <div
          className="absolute inset-0 -z-10 opacity-[0.12] dark:opacity-[0.06]"
          style={{
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1 max-w-2xl">
              <div className="flex items-center gap-3 mb-6">
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-100 dark:bg-blue-500/15 border border-blue-300 dark:border-blue-500/25 text-blue-700 dark:text-blue-300 text-[13.5px] font-semibold">
                  Enterprise CRM · AI-Powered
                </span>
                <span className="text-gray-600 dark:text-gray-500 text-[13.5px]">Nonprofit · Stakeholder Management</span>
              </div>
              ...
              <div className="grid grid-cols-3 divide-x divide-gray-200 dark:divide-white/10 border border-gray-200 dark:border-white/10 rounded-2xl bg-white dark:bg-white/[0.04] shadow-sm dark:shadow-none backdrop-blur-sm max-w-md">
                {[
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {PAIN_POINTS.map((point, i) => (
              ...
              >
                ...
                <p className="text-blue-100 text-[16px] leading-relaxed">{point.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50/60 dark:bg-gray-900/20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-600 dark:text-blue-400 text-[13.5px] font-semibold mb-4">
              ...
              >
                ...
                <div className="p-7">
                  <div className="flex items-start gap-4 mb-5">
                    ...
                    <div>
                      <span className="text-[12.5px] font-semibold uppercase tracking-wider text-blue-500 dark:text-blue-400">
                        {feature.tag}
                      </span>
                  ...
                  <p className="text-[15.5px] text-gray-600 dark:text-gray-300 leading-relaxed mb-5">
                    {feature.description}
                  </p>

                  <ul className="space-y-2.5">
                    {feature.bullets.map((b) => (
                      <li key={b} className="flex items-start gap-2.5 text-[14.5px] text-gray-500 dark:text-gray-400">
                        <svg
